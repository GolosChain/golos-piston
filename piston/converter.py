...
class Converter(object):
    ...
    def sbd_median_price(self):
        ...
        """
        return (
            Amount(self.steem.rpc.get_feed_history(api='database_api')['current_median_history']['base']).amount /
            Amount(self.steem.rpc.get_feed_history(api='database_api')['current_median_history']['quote']).amount
        )

    def steem_per_mvests(self):
        """ Obtain STEEM/MVESTS ratio
        """
        info = self.steem.rpc.get_dynamic_global_properties(api='database_api')
        return (
    ...
    def sbd_to_rshares(self, sbd_payout):
        ...
        props = self.steem.rpc.get_dynamic_global_properties(api='database_api')
